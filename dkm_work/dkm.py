...
def deep_kmeans(dataset="CLASSIC3",params:dict=PARAMS,n_runs=1) -> dict:
    """
        input:
            ...
            -params: parameter of DeepKMeans (see globals file and repo: "https://github.com/MaziarMF/deep-k-means")
        return:
    ...
    validation = params["validation"] # Specify if data should be split into validation and test sets
